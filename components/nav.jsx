...
export default function MobileMenu() {
  ...
  return (
    <div>
      <div className='w-screen h-12 fixed top-0 bg-blue-600 text-white pl-8 pr-8 flex justify-between items-center z-10 shadow-lg'>
          <p>Logo</p>
...
function MenuBody({showMenu}){
  return(
    <div className={`${showMenu ? 'visible':'hidden'} nav h-screen w-full mt-12 bg-slate-50`}>

...
function PriceCard() {
    return(
        <div class="price-card w-92  h-92 bg-white dark:bg-slate-700 rounded-lg shadow-lg border border-slate-200 dark:border-slate-500">
            <div class="content p-8">
                ...
                <button class="mt-4 bg-blue-500 dark:bg-blue-300 dark:text-slate-800 py-4 px-8 shadow-lg text-white">Enroll now</button>

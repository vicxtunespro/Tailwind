  ...
  return (
    ...
    >
        ...
        <div className="profile md:w-1/2 md:flex md:flex-col md:justify-center py-8 px-4 dark:bg-slate-600">
            ...
            className='text-xl text-buddy0 dark:text-slate-200'>{placeHolders[skillIndex]}</motion.p>
            <p className='mt-4 text-5xl font-bold text-orange-500 dark:text-white'><span className='font-light'>Hi, I'm</span> Victor <br></br> Nuwarimpa.</p>
